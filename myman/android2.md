...
modified:
categories:
excerpt: "let's check some Apps"
tags: [Android]
image:
  feature:
date: 2015-01-28T19:19:42+01:00
---
...
Here conversation is my pure xmpp client for PGP or OTR needs, as you needs:
[Orbot](https://f-droid.org/repository/browse/?fdid=org.torproject.android)   [OpenKeychain](https://f-droid.org/repository/browse/?fdid=org.sufficientlysecure.keychain)  

[ChatSecure](https://chatsecure.org/)  
Use for Facebook Chat, server: `chat.facebook.com` with your Facebook ID (www.facebook.com/user/**your.name**)  
[![F-Droid](https://lh5.googleusercontent.com/-zezQqsBye0c/VCUpPVjcKEI/AAAAAAAAAIQ/HbcG5f1qMIw/w129-h45-no/getitonfdroid.png)](https://f-droid.org/repository/browse/?fdid=info.guardianproject.otr.app.im)  
...
[Kodi](http://kodi.wiki/view/Android) alias XBMC is now *stable* ON [WebSite](http://kodi.wiki/view/HOW-TO:Install_Kodi_for_Android)  
